package com.programs.concurrency.deadlocks;
...
public class AvoidsDeadlockDemo {
	...
	class BadTransferOperation extends Thread {
		...
		/**
		 * This is the crucial point here. The idea is that to avoid deadlock you need
		 * to ensure that threads can't try to lock the same two accounts in the same
		 * order
		 */
